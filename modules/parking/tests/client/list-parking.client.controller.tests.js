(function () {
  ...
  describe('Parking List Controller Tests', function () {
    // Initialize global variables
    var ParkingListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _ParkingService_) {
      ...
      // Initialize the Parking List controller.
      ParkingListController = $controller('ParkingListController as vm', {
        $scope: $scope
      });
